...
client.on('guildMemberAdd', member => {
  ...
  .setTitle(':inbox_tray: | Sunucuya katıldı! Hoş Geldin Kral')
  .setTimestamp()
...
client.on('guildMemberRemove', member => {
  ...
  .setAuthor(member.user.username, member.user.avatarURL)
  .setThumbnail(member.user.avatarURL)
  .setTitle(':outbox_tray: | Sunucudan ayrıldı . Ayıp Etti ')
  .setTimestamp()
  channel.sendEmbed(embed); 
});
...
let botdurum = client.channels.find(c => c.id === '614473744580083722')//Botun sürekli mesaj atacağı kanal.
...
.addField(`Bilgi`,`${client.guilds.size.toLocaleString()} sunucu ve ${client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} kullanıcıya hizmet veriyor.`)
.setTimestamp()
.setFooter('');
botdurum.send(botistatistik);
  }, 100000); //Milisaniye cinsinden. 1 saniye =  1000 milisaniye. Örnek Olarak 1 saat = 3600000milisaniye
